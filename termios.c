...
//	printf("\n");
	af_log_print(APPF_MASK_CLIENT+LOG_DEBUG, "%s",buf);
...
//	printf("c_ospeed\t"); printspeed(cfgetospeed(&t), 1, 1); printf("\n");
	sprintspeed(buf,cfgetispeed(&t), 1, 1); printf("\n");
	af_log_print(APPF_MASK_CLIENT+LOG_DEBUG, "c_ispeed\t%s",buf);
	sprintspeed(buf,cfgetospeed(&t), 1, 1); printf("\n");
	af_log_print(APPF_MASK_CLIENT+LOG_DEBUG, "c_ospeed\t%s",buf);
#endif
